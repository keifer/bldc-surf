...
#define EXT_BUZZER_ON()			palSetPad( HW_BUZZER_GPIO,HW_BUZZER_PIN)
#define EXT_BUZZER_OFF()		palClearPad(HW_BUZZER_GPIO,HW_BUZZER_PIN)
...
#define CURRENT_SHUNT_RES		( 0.001 / 2)
#endif
...
// Setting limits
//#define HW_LIM_CURRENT			-275.0, 275.0 //0.0003 ohm 
#define HW_LIM_CURRENT			-165.0, 165.0 //0.005 ohm 
