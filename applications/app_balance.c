...
void app_balance_configure(balance_config *conf, imu_config *conf2)
{
	...
	case SHUTDOWN_MODE_OFF_AFTER_5M:
		autosuspend_timeout = 60 * 5;
		break;
	case SHUTDOWN_MODE_OFF_AFTER_10M:
		autosuspend_timeout = 60 * 10;
		break;
	case SHUTDOWN_MODE_OFF_AFTER_30M:
		autosuspend_timeout = 60 * 30;
		break;
	case SHUTDOWN_MODE_OFF_AFTER_1H:
		autosuspend_timeout = 60 * 60;
		break;
	case SHUTDOWN_MODE_OFF_AFTER_5H:
		autosuspend_timeout = 60 * 60 * 5;
		break;
	default:
...
void apply_torquetilt(void)
{
	...
	if (SIGN(integral) != SIGN(erpm))
	{ // integral windup after braking
